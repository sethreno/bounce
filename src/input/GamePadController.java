...
public class GamePadController {
	...
	/*
	 * Search the array of controllers until a suitable game pad controller is found
	 * (eith of type GAMEPAD or STICK).
	 */
	{
	...
	/*
	 * Search through comps[] for id, returning the corresponding array index, or -1
	 */
	{
		Component c;
	 ...
	 * buttonsIdx[]. Ignore excessive buttons. If there aren't enough buttons, then
	 * fill the empty spots in buttonsIdx[] with -1's.
	 */
	{
	...
	/*
	 * Return true if the component is a digital/absolute button, and its identifier
	 * name ends with "Button" (i.e. the identifier class is
	 ...
	 * range 1-NUM_BUTTONS to match the game pad button labels.
	 */
	{
